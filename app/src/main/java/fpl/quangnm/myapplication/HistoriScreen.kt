...
class HistoriScreen : ComponentActivity() {
...
fun HomeLichSu() {
    ...
    Scaffold(
        bottomBar = { BottomNavigationBarHistori() }
    ) { innerPadding ->
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            Text(text = "Lịch đặt cơm", fontSize = 25.sp, color = Color.White, fontWeight = FontWeight.Bold , modifier = Modifier.padding(bottom = 70.dp))
            Image(
                painter = painterResource(id = R.drawable.historybook),
                contentDescription = "Logo",
                modifier = Modifier
                    .size(240.dp)
                    .padding(end = 15.dp)
            )
            Text(text = "Không có đơn hàng nào được đặt", color = Color.Red, fontSize = 20.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(top = 30.dp, bottom = 10.dp))
            Text(text = "Bạn nên nhấn vào nút để có thể đặt đồ ăn", color = Color.White, fontSize = 18.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(bottom = 30.dp))
...
@Composable
fun BottomNavigationBarHistori() {
    val mauCam = Color(0xFFFE724C)
